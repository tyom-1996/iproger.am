...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <section class="section-2">
            <div class="section-2-wrap">
                ...
                <h2 class="section-2-wrap-title section-title">
                    <span class="title-left-line"></span>
                    FEATURED JOBS
        ...
        <section class="section-3">
            ...
            <div class="section-3-wrap">
                <div class="section-3-left" style="background: url({{asset('images/left.jpg')}});background-size:cover ">
                    <div class="sect3-bg" style="background: #7cb347f0;">
                ...
                <section class="section-5">
                    <div class="section-5-wrap">
                        ...
                        <h2 class="section-5-wrap-title section-title">
                            <span class="title-left-line"></span> How it works<span class="title-right-line"></span>
                        </h2>
    ...
    <script>
        ...
        function generalSearchInput() {
            ...
            if (_delete) {
                setTimeout("generalSearchInput()", 400);
            } else{
                setTimeout("generalSearchInput()", time);
            }
        }
